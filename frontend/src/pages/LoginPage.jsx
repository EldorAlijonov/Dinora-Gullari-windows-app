...
import { Flower2, Lock, Phone, UserRound } from 'lucide-react';
...
const schema = z.object({
  login: z.string().min(3, 'Login, telefon yoki email kiriting'),
...
export default function LoginPage() {
  ...
  const onSubmit = async (values) => {
    ...
    navigate(result?.user?.role === 'service' ? '/service' : '/', { replace: true });
  };
        ...
        <div className="relative min-h-[420px] overflow-hidden bg-gradient-to-br from-rose-500 via-pink-500 to-emerald-500 p-8 text-white">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            ...
            <div>
              ...
              <p className="mt-3 max-w-sm text-base font-medium text-white/85">Buyurtmalar, sotuvlar, foyda va qarzlar bir joyda.</p>
            </div>
